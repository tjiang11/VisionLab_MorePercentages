...
//    }
    ...
    private void updateDotColors() {
        dotsColorOne = Color.YELLOW;
        dotsColorTwo = Color.BLUE;
    }
    /** 
    ...
    private void setTheQuestion() {
        ...
        case DotsPairGenerator.MORE_THAN_TWENTYFIVE_BLOCK:
        	theView.getQuestion().setText("25%");
        	break;
        case DotsPairGenerator.MORE_THAN_FORTY_BLOCK:
        	theView.getQuestion().setText("40%");
        	break;
        case DotsPairGenerator.MORE_THAN_FIFTY_BLOCK:
            theView.getQuestion().setText("50%");
            break;
        case DotsPairGenerator.MORE_THAN_SIXTY_BLOCK:
            theView.getQuestion().setText("60%");
            break;
        case DotsPairGenerator.MORE_THAN_SEVENTYFIVE_BLOCK:
        	theView.getQuestion().setText("75%");
            break;
        default:
            theView.getQuestion().setText("Is " + colorOneName + " more than " + colorTwoName + "?");
        }    
    	theView.getQuestion().setTextFill(Color.YELLOW);
    }
